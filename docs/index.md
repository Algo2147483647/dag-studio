...
This directory contains the main user and developer documentation for DAG Studio.

## Start Here

- [Usage Guide](usage.md): how to navigate, edit, and save graphs in the UI
- [Data Format Guide](data-format.md): how graph JSON is shaped and normalized
